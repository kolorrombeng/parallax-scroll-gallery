...
const ProjectsSection = () => {
  ...
  const originalProjects = [
    // Nilai offsetY disesuaikan agar tidak terlalu ekstrem
    ...
    { id: 2, title: "Web Experience", category: "UI/UX", image: project2, size: "medium", offsetY: 50, marginLeft: 30, description: "Modern web experience focused on user engagement and intuitive navigation.", borderRadius: "rounded-xl" },
    { id: 3, title: "Mobile App", category: "Product", image: project3, size: "small", offsetY: -40, marginLeft: 20, description: "Native mobile application with seamless user experience.", borderRadius: "rounded-3xl" },
    { id: 4, title: "Visual System", category: "Design System", image: project4, size: "large", offsetY: 100, marginLeft: 40, description: "Comprehensive design system for consistent user interfaces.", borderRadius: "rounded-lg" },
    ...
    { id: 6, title: "Art Direction", category: "Creative", image: project2, size: "small", offsetY: 80, marginLeft: 35, description: "Creative direction for digital and print campaigns.", borderRadius: "rounded-xl" },
    ...
    { id: 8, title: "Motion Design", category: "Animation", image: project4, size: "medium", offsetY: 120, marginLeft: 45, description: "Engaging motion graphics and animated experiences.", borderRadius: "rounded-lg" },
    ...
    { id: 12, title: "Package Design", category: "Print", image: project4, size: "small", offsetY: 150, marginLeft: 25, description: "Product packaging design with eco-friendly materials.", borderRadius: "rounded-lg" },
